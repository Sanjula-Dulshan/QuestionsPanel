...
<body>
	...
	<div class="container col-md-5"><br><br>
		<div class="card">
			<div class="card-body">
			<h3 class="text-center">Delete Question</h3>
			<hr>
				...
				<div style="display:none;"> <input type = "text" value ="${q.id}" name = "questionID" readonly> </div> <!-- hide text in the page -->
					...
					<label>Subject</label><select class="form-control" name="subject" required="required" disabled>
				...
				<fieldset class="form-group">
				 	<label>Question </label><input type = "text" value ="${q.question}" class="form-control" name ="question" required="required" readonly>
				 </fieldset>
				 
				 <fieldset class="form-group">
				 	<label>Answer 1</label> <input type = "text" value ="${q.answer1}" class="form-control" name ="answer1" required="required" readonly>
				 </fieldset>
				 
				 <fieldset class="form-group">
				 	<label> Answer 2</label> <input type = "text" value ="${q.answer2}" class="form-control" name ="answer2" required="required" readonly>
				 </fieldset>
				 
				 <fieldset class="form-group">
				 	<label> Answer 3</label> <input type = "text" value ="${q.answer3}" class="form-control" name ="answer3" required="required" readonly>
				 </fieldset>
				 
				 <fieldset class="form-group">
				 	<label> Answer 4 </label><input type = "text" value ="${q.answer4}" class="form-control" name ="answer4" required="required" readonly>
				 </fieldset>
				 
				 <fieldset class="form-group">
					<label>Correct Answer</label><select class="form-control" name="cAnswer" required="required" disabled>
				 	...
				 	<input type = "submit"  class="btn btn-success" name ="submit" style="background-color: #f44336;" value = "Delete">	
				</c:forEach>
				</form>
			</div>
		</div>
